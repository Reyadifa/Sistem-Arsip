        ...
        <div class="flex-grow p-6">
            ...
            <form action="{{ route('arsip.update', $arsip->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <select name="id_kategori" id="id_kategori" class="w-full rounded-lg border-gray-300 p-4 text-sm shadow-sm bg-gray-100 text-black" required>
                ...
                <div>
                    ...
                    <input type="text" name="nama_usaha" id="nama_usaha" value="{{ $arsip->nama_usaha }}" class="w-full rounded-lg border-gray-300 p-4 text-sm shadow-sm bg-gray-100 text-black" required>
                </div>

                <div>
                    <label for="alamat_usaha" class="block text-sm font-medium text-gray-600">Alamat Usaha</label>
                    <input type="text" name="alamat_usaha" id="alamat_usaha" value="{{ $arsip->alamat_usaha }}" class="w-full rounded-lg border-gray-300 p-4 text-sm shadow-sm bg-gray-100 text-black" required>
                </div>

                <div>
                    <label for="nama_pemilik" class="block text-sm font-medium text-gray-600">Nama Pemilik</label>
                    <input type="text" name="nama_pemilik" id="nama_pemilik" value="{{ $arsip->nama_pemilik }}" class="w-full rounded-lg border-gray-300 p-4 text-sm shadow-sm bg-gray-100 text-black" required>
                </div>

                <div>
                    <label for="alamat_pemilik" class="block text-sm font-medium text-gray-600">Alamat Pemilik</label>
                    <input type="text" name="alamat_pemilik" id="alamat_pemilik" value="{{ $arsip->alamat_pemilik }}" class="w-full rounded-lg border-gray-300 p-4 text-sm shadow-sm bg-gray-100 text-black" required>
                </div>

                <div>
                    <label for="npwp" class="block text-sm font-medium text-gray-600">NPWP</label>
                    <input type="text" name="npwp" id="npwp" value="{{ $arsip->npwp }}" class="w-full rounded-lg border-gray-300 p-4 text-sm shadow-sm bg-gray-100 text-black" required>
                </div>

                <div>
                    <label for="bulan" class="block text-sm font-medium text-gray-600">Bulan</label>
                    <select name="bulan" id="bulan" class="w-full rounded-lg border-gray-300 p-4 text-sm shadow-sm bg-gray-100 text-black" required>
                ...
                <div>
                    ...
                    <input type="text" name="tahun" id="tahun" value="{{ $arsip->tahun }}" class="w-full rounded-lg border-gray-300 p-4 text-sm shadow-sm bg-gray-100 text-black" required>
                </div>

                <div>
                    <label for="file" class="block text-sm font-medium text-gray-600">File</label>
                    <input type="file" name="file" id="file" class="w-full rounded-lg border-gray-300 p-4 text-sm shadow-sm bg-gray-100 text-black">
                </div>

                <button type="submit" class="w-full py-3 px-4 text-white bg-blue-600 rounded-lg hover:bg-blue-700">Simpan</button>
            </form>
        </div>
    </div>
</body>
