                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td class="px-4 py-3 text-left text-xs font text-black-500 border-r border-black border-b">
                                        @if ($arsip->file_path)
                                            ...
                                            <div class="bg-yellow-500 border hover:bg-yellow-600 w-12 text-base py-2 rounded-lg font-bold flex items-center justify-center cursor-pointer">
                                                <a href="{{ asset('storage/' . $arsip->file_path) }}" class="text-white hover:underline" target="_blank">
                                    ...
                                    <td class="border-black border-b">
                                        <div class="flex items-center px-2 py-3 justify-center space-x-2">
                                            ...
                                            <!-- Tombol Hapus -->
                                            <form id="delete-form-{{ $arsip->id }}" action="{{ route('arsip.destroy', $arsip->id) }}" method="POST" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" class="px-4 py-2 text-white bg-red-500 hover:bg-red-600 rounded-lg" onclick="confirmDelete({{ $arsip->id }})">
