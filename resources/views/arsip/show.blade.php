        ...
        <div class="bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div class="mb-6">
                    ...
                    @if($arsip->file_path)
                        <div class="flex items-center space-x-4">
                            ...
                            <button class="bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition duration-150">Download</button>
                        </div>
                    @else
                ...
                <div class="flex justify-between">
                    <a href="{{ route('arsip.edit', $arsip->id) }}" class="bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition duration-150">Edit</a>
                    <form action="{{ route('arsip.destroy', $arsip->id) }}" method="POST" class="ml-4">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="bg-red-600 text-white py-2 px-4 rounded-md hover:bg-red-700 transition duration-150">Hapus</button>
                    </form>
                </div>
            </div>
        </div>
