                    ...
                    <table class="min-w-full table-auto divide-y divide-gray-300">
                        <thead class="bg-blue-500">
                            <tr>
                                ...
                                @if (auth()->user() && in_array(auth()->user()->role, ['1', '2']))
                                    <th
                                        class="px-5 py-3 text-center text-xs font text-white font-bold border-black border-b">
                                        Aksi</th>
                                @endif
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-100">
                                    ...
                                    <td
                                        ...
                                        @if ($peminjaman->arsip && $peminjaman->arsip->file_path)
                                            <a href="{{ asset('storage/' . $peminjaman->arsip->file_path) }}"
                                                target="_blank" class="mx-auto flex justify-center">
                                                <i
                                    ...
                                    <!-- Status Column dengan styling warna yang lebih baik -->
                                    <td
                                        class="px-4 py-3 text-center text-xs font text-black-500 border-r border-black border-b">
                                        @php
                                            $statusClass = '';
                            ...
                            @empty
                                <tr>
                                    <td colspan="13" class="px-4 py-60 text-center text-xl text-gray-500 font-bold">Tidak
                                        ada peminjaman</td>
                                </tr>
                            @endforelse
                        </tbody>
