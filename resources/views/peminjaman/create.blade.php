    ...
    <main class="p-10 bg-white max-1xl rounded-xl space-y-6  mx-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
            ...
            <div>
                ...
                <select name="npwp" id="npwp" class="w-full p-3 rounded-lg border-black border"
                    ...
                    @foreach ($arsipsGrouped as $key => $arsips)
                        ...
                        <option value="{{ $firstArsip->npwp }}"
                            {{ old('npwp') == $firstArsip->npwp ? 'selected' : '' }}>
            ...
            <!-- Dropdown Arsip - Selalu tampil tapi disabled jika NPWP belum dipilih -->
            <div>
                <label for="arsip_id" class="block font-bold text-black mb-1">Pilih Arsip</label>
                <select name="arsip_id" id="arsip_id" class="w-full p-3 rounded-lg border-black border"
                    onchange="updateFileInfo()" required disabled>
            ...
            <div>
                ...
                <input type="date" class="w-full p-3 rounded-lg border-black border" id="tgl_minjam"
                    name="tgl_minjam" placeholder="Pilih Tanggal Pinjam" value="{{ old('tgl_minjam') }}" required>
            </div>
            ...
            <div>
                ...
                <input type="date" class="w-full p-3 rounded-lg border-black border" id="tgl_kembali"
                    name="tgl_kembali" placeholder="Pilih Tanggal Kembali" value="{{ old('tgl_kembali') }}"
                    required>
            </div>
            ...
            <div>
                ...
                <input type="text" class="w-full p-3 rounded-lg border-black border" id="nama_peminjam"
                    name="nama_peminjam" placeholder="Masukkan Nama Peminjam" value="{{ old('nama_peminjam') }}"
                    required>
            </div>
    ...
    <script>
        ...
        function updateArsipDropdown() {
            ...
            if (selectedNpwp && arsipsGrouped[selectedNpwp]) {
                ...
                if (oldArsipId) arsipSelect.value = oldArsipId;
            } else {
                arsipSelect.disabled = true;
            }
        }

        // On page load, set dropdown arsip sesuai npwp lama (jika ada)
