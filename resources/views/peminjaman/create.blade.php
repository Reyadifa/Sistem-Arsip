            ...
            <div class="bg-gray-50 p-6 rounded-lg border-2 border-gray-300 mb-6">
                ...
                <div class="flex justify-center gap-6">
                    <label class="flex items-center cursor-pointer">
                        <input type="radio" name="form_type" value="with_surat" id="with_surat" class="mr-2" checked onchange="toggleSuratKuasa()">
                        <span class="font-semibold text-blue-600">Dengan Surat Kuasa</span>
                    </label>
                    <label class="flex items-center cursor-pointer">
                        <input type="radio" name="form_type" value="without_surat" id="without_surat" class="mr-2" onchange="toggleSuratKuasa()">
